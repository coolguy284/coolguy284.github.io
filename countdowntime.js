...
UpdDate = function() {
  dl = {
    ...
    'st': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 14, 42, 0, 0),
    'shf': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 7, 53, 0, 0),
    'sht': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 7, 58, 0, 0),
    's1f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 8, 2, 0, 0),
    's1t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 8, 46, 0, 0),
    's2f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 8, 50, 0, 0),
    's2t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 9, 34, 0, 0),
    's3f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 9, 38, 0, 0),
    's3t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 10, 22, 0, 0),
    's4f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 10, 26, 0, 0),
    's4t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 11, 10, 0, 0),
    's51f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 11, 14, 0, 0),
    's51t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 11, 44, 0, 0),
    's52f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 11, 48, 0, 0),
    's52t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 12, 18, 0, 0),
    's6f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 12, 22, 0, 0),
    's6t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 13, 6, 0, 0),
    's7f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 13, 10, 0, 0),
    's7t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 13, 54, 0, 0),
    's8f': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 13, 58, 0, 0),
    's8t': new Date(date.getFullYear(), date.getMonth(), date.getDate(), 14, 42, 0, 0),
